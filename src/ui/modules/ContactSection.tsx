...
const Newsletter: React.FC<ContactSectionProps> = ({
  ...
  return (
    <section className="py-24 bg-gray-50" key={_key}>
                ...
                {!submitted ? (
                  ...
                  <div className="bg-green-50 p-8 rounded-xl text-center">
                    ...
                    <p className="text-gray-600 text-lg mb-6">
                      Vi har mottatt din kontaktinformasjon og vil svare deg så snart som mulig.
                    </p>
                    <p className="text-gray-500">
                      Sjekk innboksen din for en bekreftelsesmelding. Hvis du ikke finner den, sjekk
                      spam-mappen.
                    </p>
                  </div>
                )}
